...
row : Design -> Design
row =
    direction ( "normal", "horizontal", "row" )


{-| -}
rowReverse : Design -> Design
rowReverse =
    direction ( "reverse", "horizontal", "row-reverse" )


{-| -}
column : Design -> Design
column =
    direction ( "normal", "vertical", "column" )


{-| -}
columnReverse : Design -> Design
columnReverse =
    direction ( "reverse", "vertical", "column-reverse" )
...
wrap : Design -> Design
wrap =
    wrapVendor ( "wrap", "wrap" )


{-| -}
wrapReverse : Design -> Design
wrapReverse =
    wrapVendor ( "wrap-reverse", "wrap-reverse" )


{-| -}
noWrap : Design -> Design
noWrap =
    wrapVendor ( "none", "nowrap" )
...
justifyStart =
    justifyVendor ( "start", "start", "flex-start" )


{-| -}
justifyCenter : Design -> Design
justifyCenter =
    justifyVendor ( "center", "center", "center" )


{-| -}
justifyEnd : Design -> Design
justifyEnd =
    justifyVendor ( "end", "end", "flex-end" )


{-| -}
justifyBetween : Design -> Design
justifyBetween =
    justifyVendor ( "justify", "justify", "space-between" )


{-| -}
justifyAround : Design -> Design
justifyAround =
    justifyVendor ( "none", "distribute", "space-around" )
...
alignItemsStart =
    alignItemsVendor ( "start", "flex-start" )


{-| -}
alignItemsCenter : Design -> Design
alignItemsCenter =
    alignItemsVendor ( "center", "center" )


{-| -}
alignItemsEnd : Design -> Design
alignItemsEnd =
    alignItemsVendor ( "end", "flex-end" )


{-| -}
alignItemsStretch : Design -> Design
alignItemsStretch =
    alignItemsVendor ( "stretch", "stretch" )


{-| -}
alignItemsBaseline : Design -> Design
alignItemsBaseline =
    alignItemsVendor ( "baseline", "baseline" )
...
alignContentStart =
    alignContentVendor "flex-start"


{-| -}
alignContentCenter : Design -> Design
alignContentCenter =
    alignContentVendor "center"


{-| -}
alignContentEnd : Design -> Design
alignContentEnd =
    alignContentVendor "flex-end"


{-| -}
alignContentStretch : Design -> Design
alignContentStretch =
    alignContentVendor "stretch"


{-| -}
alignContentBetween : Design -> Design
alignContentBetween =
    alignContentVendor "space-between"


{-| -}
alignContentAround : Design -> Design
alignContentAround =
    alignContentVendor "space-around"
...
alignSelfStart =
    alignSelfVendor "flex-start"


{-| -}
alignSelfCenter : Design -> Design
alignSelfCenter =
    alignSelfVendor "center"


{-| -}
alignSelfEnd : Design -> Design
alignSelfEnd =
    alignSelfVendor "flex-end"


{-| -}
alignSelfStretch : Design -> Design
alignSelfStretch =
    alignSelfVendor "stretch"


{-| -}
alignSelfBaseline : Design -> Design
alignSelfBaseline =
    alignSelfVendor "baseline"
